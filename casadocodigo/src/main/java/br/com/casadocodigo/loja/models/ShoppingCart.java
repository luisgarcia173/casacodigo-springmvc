...
public class ShoppingCart {
	...
	public Integer getQuantityDistinctItems() {
		return items.size();
	}
	...
	public BigDecimal getTotal(){
		...
		for(ShoppingItem item : items.keySet()){
			total = total.add(getTotal(item).multiply(new BigDecimal(item.getQuantity())));
		}
		return total;
	}

	public void cleanCart() {
		items = new LinkedHashMap<ShoppingItem, Integer>();
	}
